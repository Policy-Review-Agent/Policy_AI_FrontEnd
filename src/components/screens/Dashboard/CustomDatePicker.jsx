...
// ─── CalendarMonth ────────────────────────────────────────────────────────────
function CalendarMonth({ year, month, startDate, endDate, hoverDate, onDayClick, onDayHover, compact }) {
          ...
          return (
            <div
              ...
              style={{
                ...
                background: bg, color, borderRadius, cursor: "pointer",
...
// ─── PresetItem ───────────────────────────────────────────────────────────────
function PresetItem({ label, active, onClick, compact }) {
        ...
        >
          ...
          <div style={{ flex: 1, padding: compact ? "10px 8px 8px" : "14px 10px 10px", minWidth: 0 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
              ...
              <button onClick={nextMonth} style={{ background: "none", border: "1px solid #e5e7eb", borderRadius: 5, width: 22, height: 22, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#6b7280" }}>
                <svg width="9" height="9" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="4,2 8,6 4,10"/></svg>
              </button>
            </div>
            ...
            <div style={{ marginTop: 8, paddingTop: 8, borderTop: "1px solid #f0f0f0", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6 }}>
              ...
              <div style={{ display: "flex", gap: 5, flexShrink: 0 }}>
                ...
                <button
                  onClick={handleApply}
                  disabled={!startDate}
                  className={`text-[11px] px-2.5 py-1 rounded-md font-medium border-0 ${
                    startDate
